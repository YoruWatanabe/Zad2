...
public class StudentsTest
{
    ...
    private void SeedTestDB()
    {
        ...
        List<Course> courses = new List<Course>
            {
                new Course { CourseCode = "MAT", Title = "Matematyka", Instructor = "Michalina Beldzik", Schedule = "schedule1", Description = "desc", Credits = 5, Department = "dep1" },
                new Course { CourseCode = "BIOL", Title = "Biologia", Instructor = "Halina", Schedule = "schedule2", Description = "desc", Credits = 6, Department = "dep3" },
                new Course { CourseCode = "CHEM", Title = "Chemia", Instructor = "Jan Nowak", Schedule = "schedule3", Description = "desc", Credits = 7, Department = "dep3" }
            };
