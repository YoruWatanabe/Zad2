...
public class BooksTest
{
    ...
    private void SeedTestDB()
    {
        ...
        {
                new Book { BookId = "B0001", Title = "Brave New World", Author = "Aldous Huxley", ISBN = "978-0060850524", Publisher = "Harper Perennial", PublicationDate = new DateTime(2006, 11, 26), Description = "Desc... ", Genre = "Novel" }
        };
